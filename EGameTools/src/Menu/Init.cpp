...
#include <EGT\Changelog.h>
#include <EGT\Utils\Texture.h>
...
namespace EGT::Menu {
    ...
    static EGSDK::Utils::Time::Timer timePassedFromWelcomeScreen{};
    ...
    void FirstTimeRunning() {
        ...
        if (firstTimeRunningFunc) {
            firstTimeRunningFunc = false;
            timePassedFromWelcomeScreen = EGSDK::Utils::Time::Timer(10000);
